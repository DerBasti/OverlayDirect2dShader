...
#include "../Shader/GlowingWhirlEffect.h"
...
std::vector<std::pair<GUID, std::function<HRESULT(ID2D1Factory1*)>>> RegisterShaderFactory::GetShadersForRegistration() {
	...
	registrationMap.push_back(std::make_pair(CLSID_GlowingWhirlEffect, [](ID2D1Factory1* factory) { return GlowingWhirlEffect::Register(factory); }));
